...
case $answer in
    1)
echo -e "\033[33mYou choose network Y/N: \033[0m" && read  a
...
function network(){
echo -e "\033[33mHow many NIC? : \033[0m" && read NIC
if [ $NIC == 1 ] ;then
echo -e "\033[33minput your ip: \033[0m" && read ip
check_ip
echo -e "\033[33minput your mask ex(24) : \033[0m" && read mask
echo -e "\033[33minput your GW : \033[0m" && read gw
echo -e "\033[33minput your DNS : \033[0m" && read dns
...
if [ $? == 0 ];then
#ch eth0
echo -e "\033[33minput your eth0 ip : \033[0m" && read ip
check_ip
echo -e "\033[33minput your mask ex(24) : \033[0m" && read mask
echo -e "\033[33minput your GW : \033[0m" && read gw
echo -e "\033[33minput your DNS : \033[0m" && read dns
...
nmcli con up eth0 >/dev/null
#ch eth1
echo -e "\033[33minput your eth1 ip : \033[0m" && read ip
check_ip
echo -e "\033[33minput your mask ex(24) : \033[0m" && read mask
echo -e "\033[33minput your GW : \033[0m" && read gw
echo -e "\033[33minput your DNS : \033[0m" && read dns
